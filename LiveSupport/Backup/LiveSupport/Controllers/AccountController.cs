        ...
        public ActionResult Register(RegisterModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (createStatus == MembershipCreateStatus.Success)
                {
                    ...
                    Helper.SendNotifyMessage(model.Email, "Moplig.com registration", String.Format(ControllerRes.Account.Register.NewRegistrationMessage, "http://moplig.com/en/Help/QuickStart"));
                    return RedirectToAction("Index", "Home");
                }
                else
                {
